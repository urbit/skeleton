...
// `isStatement` parameter).
 ...
 function parseFunction(
  ...
  if (_tokenizer.match.call(void 0, _types.TokenType.name)) {
    ...
    _lval.parseBindingIdentifier.call(void 0, );
    _base.state.tokens[_base.state.tokens.length - 1].identifierRole = _tokenizer.IdentifierRole.FunctionScopedDeclaration;
  }

  const startTokenIndex = _base.state.tokens.length;
  parseFunctionParams();
  _expression.parseFunctionBodyAndFinish.call(void 0, functionStart, isGenerator, allowExpressionBody);
  const endTokenIndex = _base.state.tokens.length;
...
function parseClassMethod(
  ...
  _expression.parseMethod.call(void 0, functionStart, isGenerator, isConstructor);
}
...
function parseClassId(isStatement, optionalId = false) {
  ...
  if (_tokenizer.match.call(void 0, _types.TokenType.name)) {
    _expression.parseIdentifier.call(void 0, );
    _base.state.tokens[_base.state.tokens.length - 1].identifierRole = _tokenizer.IdentifierRole.BlockScopedDeclaration;
  }

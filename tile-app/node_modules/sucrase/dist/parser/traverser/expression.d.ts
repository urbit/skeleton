...
export declare function baseParseSubscripts(startPos: number, noCalls?: boolean): void;
/** Set 'state.stop = true' to indicate that we should stop parsing subscripts. */
export declare function baseParseSubscript(startPos: number, noCalls: boolean, stopState: StopState): void;
...
export declare function parseFunctionBodyAndFinish(functionStart: number, isGenerator: boolean, allowExpressionBody?: boolean, funcContextId?: number): void;
export declare function parseFunctionBody(functionStart: number, isGenerator: boolean, allowExpression: boolean, funcContextId?: number): void;

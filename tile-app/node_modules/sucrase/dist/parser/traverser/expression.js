  ...
  switch (_base.state.type) {
    ...
    case _types3.TokenType.name: {
      ...
      if (contextualKeyword === _keywords.ContextualKeyword._await) {
        ...
        _index3.next.call(void 0, );
        _statement.parseFunction.call(void 0, functionStart, false, false);
        return false;
      } else if (
        canBeArrow &&
        !_util.canInsertSemicolon.call(void 0, ) &&
      ...
      if (canBeArrow && !_util.canInsertSemicolon.call(void 0, ) && _index3.eat.call(void 0, _types3.TokenType.arrow)) {
        parseArrowExpression(functionStart, startTokenIndex);
        return true;
      }
...
// assignable list.
 ...
 function parseFunctionBodyAndFinish(
  ...
  if (_base.isTypeScriptEnabled) {
    _typescript.tsParseFunctionBodyAndFinish.call(void 0, functionStart, isGenerator, allowExpressionBody, funcContextId);
  } else if (_base.isFlowEnabled) {
    _flow.flowParseFunctionBodyAndFinish.call(void 0, functionStart, isGenerator, allowExpressionBody, funcContextId);
  } else {

...
export declare function flowParseFunctionBodyAndFinish(functionStart: number, isGenerator: boolean, allowExpressionBody: boolean | undefined, funcContextId: number): void;
export declare function flowParseSubscript(startPos: number, noCalls: boolean, stopState: StopState): void;
...
export declare function flowParseSubscripts(startPos: number, noCalls?: boolean): void;

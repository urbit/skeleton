"use strict";Object.defineProperty(exports, "__esModule", {value: true});const __init = Symbol();const __init2 = Symbol();
...
var _types = require('./parser/tokenizer/types');
 ...
 class TokenProcessor {
  ...
  constructor(
     ...
     tokens,
     isFlowEnabled,
  ) {;this.code = code;this.tokens = tokens;this.isFlowEnabled = isFlowEnabled;this[__init]();this[__init2]();}
  ...
  matchesContextualAtIndex(index, contextualKeyword) {
    return (
      this.matchesAtIndex(index, [_types.TokenType.name]) &&

 ...
 */
 class CJSImportTransformer extends _Transformer2.default {
  ...
  constructor(
    ...
    super();this.rootTransformer = rootTransformer;this.tokens = tokens;this.importProcessor = importProcessor;this.enableLegacyBabel5ModuleInterop = enableLegacyBabel5ModuleInterop;this[__init]();this[__init2]();this[__init3]();;
  }
   ...
   */
   isSimpleExportVar() {
    ...
    // var/let/const
    tokenIndex++;
    if (!this.tokens.matchesAtIndex(tokenIndex, [_types.TokenType.name])) {
      return false;
    }
    tokenIndex++;
    ...
    if (!this.tokens.matchesAtIndex(tokenIndex, [_types.TokenType.eq])) {
      return false;
    }
    return true;
  }
    ...
    while (true) {
      if (
        ...
        if (_tokenizer.isDeclaration.call(void 0, token)) {
          ...
          if (
            token.identifierRole === _tokenizer.IdentifierRole.ObjectShorthandBlockScopedDeclaration ||
            token.identifierRole === _tokenizer.IdentifierRole.ObjectShorthandFunctionScopedDeclaration
          ) {

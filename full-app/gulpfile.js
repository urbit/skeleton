...
gulp.task('css-bundle', function() {
  return gulp
    ...
    .pipe(cssimport())
    .pipe(cssnano())
    .pipe(gulp.dest('./urbit/app/skeleton/css'));
});
...
gulp.task('js-imports', function(cb) {
  return gulp.src('dist/index.js')
    ...
    .pipe(gulp.dest('./urbit/app/skeleton/js/'))
    .on('end', cb);
});

gulp.task('js-minify', function () {
  return gulp.src('./urbit/app/skeleton/js/index.js')
    .pipe(minify())
    .pipe(gulp.dest('./urbit/app/skeleton/js/'));
});
...
gulp.task('js-cachebust', function(cb) {
  return Promise.resolve(
    exec('git log', function (err, stdout, stderr) {
      ...
      exec('mv ./urbit/app/skeleton/js/index-min.js ./urbit/app/skeleton/js/' + newFilename);
    })
  );
})
